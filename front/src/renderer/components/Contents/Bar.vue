<template>
  <section class="bar">
    <section v-if="filters" class="filters">
    ...
    <section v-else class="topMenu" v-bind:class="{'active': css.isActive}">
      <section class="who">
      <span tabindex="0">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <slot/>
